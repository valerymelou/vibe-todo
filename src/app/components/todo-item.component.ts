  ...
  template: `
    ...
    >
      ...
      <div class="relative">
        ...
        @if (todo().completed) {
        <svg
          class="absolute inset-0 w-5 h-5 text-green-500 pointer-events-none animate-pulse"
          fill="currentColor"
          viewBox="0 0 20 20"
        >
          <path
      ...
      <!-- Timestamp -->
      <div
        class="text-xs text-gray-400 dark:text-gray-500 ml-2 hidden sm:block"
      >
...
export class TodoItemComponent {
  ...
  deleteTodo(): void {
    ...
    if (element) {
      ...
      const animation = this.animationService.fadeOut(element, {
        duration: 300,
      });
