...
export class AnimationService {
  ...
  fadeIn(element: HTMLElement, config: Partial<AnimationConfig> = {}): Animation {
  ...
  fadeOut(element: HTMLElement, config: Partial<AnimationConfig> = {}): Animation {
    const finalConfig = { ...this.defaultConfig, ...config };
  ...
  slideIn(element: HTMLElement, direction: 'left' | 'right' | 'up' | 'down' = 'left', config: Partial<AnimationConfig> = {}): Animation {
    const finalConfig = { ...this.defaultConfig, ...config };
  ...
  pulse(element: HTMLElement, config: Partial<AnimationConfig> = {}): Animation {
    const finalConfig = { ...this.defaultConfig, ...config };
